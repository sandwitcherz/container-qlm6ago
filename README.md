...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qlm6ago.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qlm6ago.containers.anotherwebservice.com/
...
```
git clone git@github.com:sandwitcherz/container-qlm6ago.git
cd container-qlm6ago
```
...
```
docker attach container-qlm6ago
```
